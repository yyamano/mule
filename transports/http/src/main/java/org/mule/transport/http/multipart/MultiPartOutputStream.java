...
{
    /* ------------------------------------------------------------ */
    private final byte[] __CRLF;
    private final byte[] __DASHDASH;
    ...
    /* ------------------------------------------------------------ */
    public MultiPartOutputStream(final OutputStream out, final String encoding) throws IOException
    {
        super(out);
    ...
    public void startPart(final String contentType, final String[] headers) throws IOException
    {
        ...
        out.write(__CRLF);
        out.write(("Content-Type: " + contentType).getBytes(encoding));
        out.write(("; charset=" + encoding).getBytes(encoding));
        out.write(__CRLF);
