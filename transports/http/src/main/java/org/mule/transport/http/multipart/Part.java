 ...
 * <code>multipart/form-data</code> POST request. This is an adaptation of the
 * javax.servlet.Part interface introduced into the Servlet 3.0 specification. The
 * API has been kept that same but the package has changed not to conflict with the
 * Servlet spec.
 * 
 * @since 3.0
 */
public interface Part
{
     ...
     * @throws IOException If an error occurs in retrieving the content as an
     *             <tt>InputStream</tt>
     */
     ...
     * part. This allows a particular implementation to use, for example, file
     * renaming, where possible, rather than copying all of the underlying data, thus
     * gaining a significant performance benefit.
     * 
     * @param fileName the name of the file to which the stream will be written. The
    ...
    /**
     * Returns the value of the specified mime header as a <code>String</code>. If
     * the Part did not include a header of the specified name, this method returns
     * <code>null</code>. If there are multiple headers with the same name, this
     * method returns the first header in the part. The header name is case
     ...
     *         <code>null</code> if the part does not have a header of that name
     */
     ...
     * @return a (possibly empty) <code>Collection</code> of the values of the header
     *         with the given name
     */
     ...
     * <code>Part</code>.
     * 
     * @return a (possibly empty) <code>Collection</code> of the header names of this
     *         Part
     */
