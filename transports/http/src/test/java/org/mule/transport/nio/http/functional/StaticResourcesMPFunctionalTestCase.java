...
public class StaticResourcesMPFunctionalTestCase extends FunctionalTestCase
{
    ...
    {
        final String url = String.format("http://localhost:%1d/static", port1.getNumber());
    ...
    // TODO reactivate test when HTTPS support is done
    @Ignore
    @Test
    public void testHttpsStaticResource() throws Exception
    {
        final String url = String.format("https://localhost:%2d/static", port2.getNumber());
