...
public class HttpDynamicFunctionalTestCase extends AbstractServiceAndFlowTestCase
{
    ...
    public HttpDynamicFunctionalTestCase(final ConfigVariant variant, final String configResources)
    {
    ...
    {
        return Arrays.asList(new Object[][]{{ConfigVariant.SERVICE, "http-dynamic-functional-test-flow.xml"},
