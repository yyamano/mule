...
public class PollingEtagTestCase extends AbstractServiceAndFlowTestCase
{
    ...
    {
        final Object ftc = getComponent("Test");
    ...
    public PollingEtagTestCase(final ConfigVariant variant, final String configResources)
    {
    ...
    {
        return Arrays.asList(new Object[][]{{ConfigVariant.SERVICE, "polling-etag-test-service.xml"},
