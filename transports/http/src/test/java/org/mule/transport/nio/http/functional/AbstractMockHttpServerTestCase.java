...
public abstract class AbstractMockHttpServerTestCase extends AbstractServiceAndFlowTestCase
{
    ...
    public AbstractMockHttpServerTestCase(final ConfigVariant variant, final String configResources)
    {
    ...
    protected void doSetUp() throws Exception
    {
        ...
        final MockHttpServer httpServer = getHttpServer(serverStartLatch);
