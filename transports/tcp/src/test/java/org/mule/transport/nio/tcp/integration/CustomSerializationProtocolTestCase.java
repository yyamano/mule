...
import org.mule.transport.tcp.integration.NonSerializableMessageObject;
...
public class CustomSerializationProtocolTestCase extends AbstractServiceAndFlowTestCase
{
    ...
    public static Collection<Object[]> parameters()
    {
        return Arrays.asList(new Object[][]{
            {ConfigVariant.SERVICE, "nio/custom-serialisation-mule-config-service.xml"},
            {ConfigVariant.FLOW, "nio/custom-serialisation-mule-config-flow.xml"}
        });
    }      
